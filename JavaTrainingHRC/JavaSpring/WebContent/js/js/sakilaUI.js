...
var filmStore = Ext.create('Ext.data.Store', {
    ...
    proxy: {
        type: 'ajax',
        url : '/JavaSpring/GetSakila.action',
        enablePaging: true, 
        reader: {
            type: 'json',
    ...
    items: [{ 
        ...
        buttons: [{
            ...
            handler: function(){
                ...
                if (form.isValid()) {
                    Ext.Ajax.request({
                        url: '/JavaSpring/AddSakila.action',
                        method: 'POST',
    ...
    items: [{ 
        ...
        buttons: [{
            ...
            handler: function(){
                ...
                if (form.isValid()) {
                    Ext.Ajax.request({
                        url: '/JavaSpring/EditSakila.action',
                        method: 'POST',
    ...
    items: [{ 
        ...
        buttons: [{
            ...
            handler: function(){
                ...
                if (form.isValid()) {
                    Ext.Ajax.request({
                        url: '/JavaSpring/DeleteSakila.action',
                        method: 'POST',
